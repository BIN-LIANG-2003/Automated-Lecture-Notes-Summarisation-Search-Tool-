      ...
      {documents.length ? (
        ...
        >
          {documents.map((doc) => {
            ...
            const processingMessage = ['failed', 'text_pending', 'needs_ocr', 'no_text_available', 'action_required'].includes(processingStatus)
                          ...
                          <button
                            ...
                            title={
                              !isLoggedIn
                                ...
                                : canShare
                                  ? undefined
                                  : 'Link sharing is restricted by workspace settings'
                            }
