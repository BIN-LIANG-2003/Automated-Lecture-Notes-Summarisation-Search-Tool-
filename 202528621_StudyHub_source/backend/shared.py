...
# ==========================================
# Expert 1: visual OCR service.
# Used by the frontend OCR action.
# ==========================================
...
# ==========================================
# Expert 2: language analysis service for summaries and keywords.
# Used by the frontend summarisation action.
# ==========================================
...
# ================= Download/access endpoint with S3 support =================
def uploaded_file(filename):
    ...
    # If S3 is configured, redirect to a presigned object URL.
    if S3_BUCKET and s3_client:
        try:
            # Generate a presigned URL that is valid for one hour.
            presigned_url = s3_client.generate_presigned_url(
                'get_object',
                Params={'Bucket': S3_BUCKET, 'Key': safe_filename},
                ExpiresIn=3600
            )
            # Let the browser download directly from AWS S3.
        ...
        # Without S3, read from the local upload folder.
